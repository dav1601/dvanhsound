<template>
    <div id="playlist">
        <div id="playlist-bar" class="mb-10">
            <div class="flex justify-between items-center">
                <div
                    class="playlist-bar-start d-flex items-center justify-start"
                >
                    <v-btn
                        density="default"
                        ...
                        width="50"
                        height="50"
                        class="playlist-bar-btn"
                    ></v-btn>
                    <v-breadcrumbs :items="['Home', 'Playlist']" class="ml-3">
                        <template v-slot:divider>
                            <v-icon icon="mdi-chevron-right"></v-icon>
                        </template>
                    </v-breadcrumbs>
                </div>
                <!-- ANCHOR end playlist bar start --------------------------------- -->
                <div class="playlist-bar-end flex">
                    <!-- ANCHOR search box --------------------------------- -->
                    <div
                        class="search-box rounded-xl flex justify-start align-items-center"
                    >
                        <v-icon
                            icon="mdi-magnify"
                    ...
                    <v-btn
                        ...
                        width="50"
                        height="50"
                        class="playlist-bar-btn ml-6"
                    ></v-btn>
                </div>
                <!-- ANCHOR end playlist bar end --------------------------------- -->
            </div>
            <!-- ---------- -->
        </div>
        <!-- ANCHOR end playlist bar --------------------------------- -->
        <!-- ANCHOR start astist --------------------------------- -->
        <div
            id="artist"
            class="mb-8"
